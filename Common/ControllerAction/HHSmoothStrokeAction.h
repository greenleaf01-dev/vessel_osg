#ifndef HHSMOOTHSTROKEACTION_H
#define HHSMOOTHSTROKEACTION_H
...
class HHCONTROLLERACTIONSHARED_EXPORT HHSmoothStrokeAction : public HHBaseCustomAction
{
    Q_OBJECT
