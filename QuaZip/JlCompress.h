...
/**
  ...
  */
class Q_DECL_EXPORT JlCompress {
public:
    ...
    /**
      ...
      \return true if success, false otherwise.
      */
    static bool compressSubDir(QuaZip* parentZip, QString dir, QString parentDir, QDir::Filters filters, bool recursive = true );
	static bool compressSubDir(QuaZip* parentZip, QString dir, QString parentDir, QString password, bool recursive,
...
public:
	...
	static bool compressDir(QString fileCompressed, QString dir, bool recursive, QString password,
                                 QStringList m_vAttachFiles,
                                 QStringList m_vFileLibraryFiles,
                                 QStringList m_vFileIndexFiles);
